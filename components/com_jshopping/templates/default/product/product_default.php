        ...
        <div class="jshop_prod_description">
            ...
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#techCharact" aria-controls="home" role="tab" data-toggle="tab">ТЕХНІЧНІ ХАРАКТЕРИСТИКИ</a></li>
                    <li role="presentation"><a href="#description" aria-controls="profile" role="tab" data-toggle="tab">ОПИС</a></li>
                    <li role="presentation"><a href="#gallery" aria-controls="messages" role="tab" data-toggle="tab">ГАЛЕРЕЯ</a></li>
                </ul>
                <div class="clear"></div>
